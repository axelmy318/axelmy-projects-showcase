...
const initialState = {
    ...
    projects: [
        ...
        {
            type: 'package',
            path: '/express-ts-validator',
            name: 'Express TS Validator',
            github: {
                username: 'axelmy318',
                repository: 'express-ts-validator',
                mainBranch: 'master',
                readmeLanguages: {
                    en: 'README',
                }
            },
            npmjs: 'https://www.npmjs.com/package/express-ts-validator',
